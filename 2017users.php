    ...
    $sql = "SELECT seven_ts_title, seven_ts_artist, seven_ts_album FROM Seventeen_TS";
     ...
     $queryResult = $result->execute();
        ...
        while($row = $queryResult->fetchArray(SQLITE3_ASSOC))
        {
            ...
            <div class = 'songs'>
            <p><input type= 'checkbox' name = songs[] value = ".$row['seven_ts_title']." ".$row['seven_ts_artist']."  ".$row['seven_ts_album']." /> ".$row['seven_ts_title']." ".$row['seven_ts_artist']." ".$row['seven_ts_album']."  </p>
